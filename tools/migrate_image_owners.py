...
import sps.context
import sps.db.sqlalchemy.api as db_api
import sps.openstack.common.log as logging
import sps.registry.context
...
if __name__ == "__main__":
    ...
    config(project='sps', prog='sps-registry')

    db_api.configure_db()

    context = sps.common.context.RequestContext(is_admin=True)
