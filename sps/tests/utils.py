...
def fork_exec(cmd,
    ...
    example: sps-api.  When sps-api starts it sets itself as
...
class RegistryAPIMixIn(object):
    ...
    def get_api_response_ext(self, http_resp, url='/demos', headers=None,
