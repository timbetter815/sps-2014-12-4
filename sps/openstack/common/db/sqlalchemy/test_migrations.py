...
from sps.openstack.common.db.sqlalchemy import utils
from sps.openstack.common.gettextutils import _LE
from sps.openstack.common import test
...
def _set_db_lock(lock_path=None, lock_prefix=None):
    def decorator(f):
        ...
        def wrapper(*args, **kwargs):
            try:
                path = lock_path or os.environ.get("sps_LOCK_PATH")
