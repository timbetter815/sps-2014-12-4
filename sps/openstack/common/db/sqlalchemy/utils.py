...
from sps.openstack.common import context as request_context
from sps.openstack.common.db.sqlalchemy import models
from sps.openstack.common.gettextutils import _, _LI, _LW
...
# copy from sps/db/sqlalchemy/api.py
...
def drop_unique_constraint(migrate_engine, table_name, uc_name, *columns,
    ...
    DEPRECATED: this function is deprecated and will be removed from sps.db
