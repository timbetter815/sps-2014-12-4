...
class PropertyRules(object):
    ...
    def __init__(self, policy_enforcer=None):
        ...
        self.policies = []
        self.policy_enforcer = policy_enforcer or sps.api.policy.Enforcer()
    ...
    def _add_policy_rules(self, property_exp, action, rule):
        ...
        "prop_a:create": "rule:sps_creator"
        where sps_creator is defined in policy.json. For example:
        "sps:creator": "role:admin or role:sps_create_user"
        """
        rule = "rule:%s" % rule
